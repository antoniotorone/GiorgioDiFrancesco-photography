...
1. As a first-time visitor, I want easily understand wich kind of wesite is.
   ...
   1. The website home is structured to give a warm welcome from the owner with this showy logo that includes the "photography" word and help the user to understand what everything is about and also the images immediately shown, help to get so easy the website idea. 
      ...
      to make the user curious. [View-here] (url) 
...
1. I was expected to get the map working well and smooth after to open the website after deployed.

##### Result

1. Like a result I got the error: "Api error, your site URL to be authorized". Bug shown by console [View here:] (https://res.cloudinary.com/anto8913/image/upload/v1621631707/2nd%20milestone-image/testing/result-testing-map_uheceu.jpg)

##### Fix

1. The issue was coming from the api key restriction where the url address got after the deployment was not included. 
   I added it to the key restriction.

#### Testing Email js

##### Expected

1. After set up all emailjs codes, the form was working very well, but as I soon copied and paste in the others website pages i was expected the same result but I failed.

##### Result

1. The result that I got was the (304) error, everythime that I tried to send a request by the form.
...
1. After looking around the website and trought the codes I noticed that when I copied and paste the form I didn't also paste the emailjs.init() method
   ...
   I fixed to implement it everywhere.

### Testing in the browser and mobile devices

1. The website has been tested in Opera, Microsoft Explorer browsers, iphone 11, sony xperia x1 ultra and samsung with a positive response and not any layout issues.
